...
return array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Set this to true if you want lazychef to handle your 404 errors
	| gracefully.
	|
	*/
	'handles_404' => false,
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Checks if this is installed in lazychef/lazychef
	|
	*/
	'in_framework' => false,
	...
	|--------------------------------------------------------------------------
	|
	| Any other view directories you may want loaded for Lazychef to work
	|
	*/
	'view_dirs' => array(),
);
