...
use Lazychef\Core\Repositories\DbUserRepository as UserRepositoryInterface;
...
class UserCommand extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'lazychef:user:create';
	 ...
	 * @var string
	 */
	protected $description = 'Creates a user for LazychefCMS.';
