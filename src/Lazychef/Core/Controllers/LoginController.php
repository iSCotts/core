...
use View, Input, Redirect, Auth, Lazychef;
...
class LoginController extends BaseController {
	 ...
	 *
	 * @param  \Lazychef\UserRepositoryInterface
	 */
	protected $users;
	...
	public function store()
	{
		...
		{
			return Redirect::route('lazychef.admin.index');
		}
	...
	{
		$this->auth->logout();
		return Redirect::to('lazychef/login');
	}
