...
this.Lazychef = (function(Backbone, Marionette) {
  var App;
...
this.Lazychef.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("Controllers", function(Controllers, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("Views", function(Views, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("AccountApp", function(AccountApp, App, Backbone, Marionette, $, _) {
  var API;
...
this.Lazychef.module("AccountApp.Edit", function(Edit, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("AccountApp.List", function(List, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("AccountApp.New", function(New, App, Backbone, Marionette, $, _) {
...
this.Lazychef.module("DropzoneApp", function(DropzoneApp, App, Backbone, Marionette, $, _) {
  var API;
  API = {
...
this.Lazychef.module("HeaderApp", function(HeaderApp, App, Backbone, Marionette, $, _) {
  var API;
...
this.Lazychef.module("HeaderApp.List", function(List, App, Backbone, Marionette, $, _) {
  return List.Controller = (function(_super) {
...
this.Lazychef.module("PostApp.Edit", function(Edit, App, Backbone, Marionette, $, _) {
  return Edit.Controller = (function(_super) {
...
this.Lazychef.module("PostApp.List", function(List, App, Backbone, Marionette, $, _) {
  return List.Controller = (function(_super) {
...
this.Lazychef.module("PostApp.New", function(New, App, Backbone, Marionette, $, _) {
  return New.Controller = (function(_super) {
...
this.Lazychef.module("PostApp", function(PostApp, App, Backbone, Marionette, $, _) {
  var API;
